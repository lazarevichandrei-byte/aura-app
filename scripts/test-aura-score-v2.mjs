...
const mod=await import(pathToFileURL(path.join(outDir,"score/score-v2.js")).href);
const {scoreAuraMatchV2}=mod;
...
console.log("AURA Score V2 tests passed",{noConversation:noConversation.totalScore,balanced:good.totalScore,oneSided:weak.totalScore,cooldown:cooldown.totalScore});
