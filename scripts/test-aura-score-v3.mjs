...
const {scoreAuraMatchV3}=require(path.resolve(outDir,"score/score-v3.js"));
...
console.log("AURA_SCORE_V3_SHADOW_TESTS_PASS",{good:good.totalScore,unread:unread.totalScore,asymmetric:asymmetric.totalScore});
